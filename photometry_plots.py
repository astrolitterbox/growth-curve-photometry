...
def main():
    ...
    graph.plotScatter([gc_magData], "/analysis/gc_mag_vs_nadine", plot.PlotTitles("Comparison between my and Nadine's photometry values", "gc r magnitude, mag", "Nadine's gc magnitude, mag"), (11, 16, 11, 16))

    gc_magData = plot.GraphData(((sdss_mag, gc_mag)), 'k', 'best')
    graph.plotScatter([gc_magData], "/analysis/gc_mag_vs_sdss", plot.PlotTitles("Comparison between my and SDSS photometry values", "gc r magnitude, mag", "SDSS Petrosian r magnitude, mag"),(11, 16, 11, 16))

    gc_magData = plot.GraphData(((atlas_mag, gc_mag)), 'k', 'best')
    graph.plotScatter([gc_magData], "/analysis/gc_mag_vs_nsatlas", plot.PlotTitles("Comparison between my and NASA Sloan Atlas photometry values", "gc r magnitude, mag", "NSAtlas magnitude, mag"),(11, 16, 11, 16))

    gc_magData = plot.GraphData(((atlas_mag, sdss_mag)), 'k', 'best')
    graph.plotScatter([gc_magData], "/analysis/sdss_mag_vs_nsatlas", plot.PlotTitles("Comparison between SDSS and NASA Sloan Atlas photometry values", "SDSS Petrosian r magnitude, mag", "NSAtlas magnitude, mag"),(11, 16, 11, 16))
    ...
    graph.plotScatter([plotData], "/analysis/sdss_sky_comparison", plot.PlotTitles("Comparison between my and SDSS sky values", "counts", "counts"), (70, 170, -1, 1))
